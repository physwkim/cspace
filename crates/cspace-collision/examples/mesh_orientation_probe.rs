...
//! Probe: does `cspace_collision`'s production `check_robot_collision` path
...
//! (`crates/cspace-collision/src/parry.rs:2429`) found it structurally inert
...
//! moved. `crates/cspace-collision/tests/
