...
// Does NOT touch `crates/cspace-collision/src/parry.rs` -- this calls
...
//!
//! `crates/cspace-collision/src/parry.rs`'s own comment on
...
//!
//! Run: `cargo run -p cspace-collision --example probe_gjk_positive_gap_boundary --release`
...
fn main() {
    ...
    // `crates/cspace-collision/src/parry.rs`'s `convert_shape` applies
