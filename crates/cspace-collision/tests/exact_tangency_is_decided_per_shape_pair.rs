...
//! (`crates/cspace-collision/src/fcl_tangency_table.rs`, generated from the
...
//! (`crates/cspace-collision/src/parry.rs`) treats any `dist` within
...
//! `bool` did. `crates/cspace-collision/examples/mesh_orientation_probe.rs`
...
//! unchanged. `crates/cspace-collision/tests/
...
//! `cargo nextest run -p cspace-collision -E
