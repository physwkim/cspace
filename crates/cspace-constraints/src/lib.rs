...
//! `rg -c '^//! - `' crates/cspace-constraints/src/lib.rs` is **61** — the
...
//! crates/cspace-constraints/src/lib.rs` is **66**, one bullet per
...
//! `rg -c '^mod oracle_' crates/cspace-constraints/tests/utils_parity.rs`
...
//! (`sed -n '176,555p' crates/cspace-constraints/tests/utils_parity.rs | rg
...
//!
//! Reproduction: `rg -c '^//! - CS:' crates/cspace-constraints/src/lib.rs`
...
//! with `rg -c '^//! - CS:.*-> TAG' crates/cspace-constraints/src/lib.rs`
//! for the given `TAG`:
//!
...
//!
//! `grep -rn 'assert_relative_eq!(' crates/cspace-constraints/ --include=*.rs
