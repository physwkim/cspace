...
//! constraint parameters this file builds through `cspace_constraints::utils`)
//! at `moveit-rs/oracle:5188956fc433d046`. This doubles as the first oracle
//! parity check for [`cspace_constraints::Constraint::decide`] itself
...
//! several distinct `cspace_constraints::utils` construction functions, not
...
fn assert_matches_oracle(actual: &[cspace_constraints::ConstraintEvaluationResult], id: u32) {
