...
//!
//! ```text
//! rg -c '^//! - `' crates/cspace-core/src/geometry/shapes.rs                      # whole-file bullet count
//! awk 'NR==247,NR==371' crates/cspace-core/src/geometry/bodies.rs | grep -c '^//! - `'  # the round-8 audit block only
//! ```
//!
...
//! assert_relative_eq! crates/cspace-core/src/geometry/*.rs` (13, the exact
...
//!   (`rg -n serde_json crates/cspace-core/src/geometry/bodies.rs
//!   crates/cspace-core/src/geometry/transforms.rs` -- no match, neither file
