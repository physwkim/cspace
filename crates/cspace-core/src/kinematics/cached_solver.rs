...
use crate::kinematics::ik_cache::{IkCache, IkCacheOptions};
use crate::kinematics::lma::LevenbergMarquardtSolver;
use crate::kinematics::newton_raphson::NewtonRaphsonSolver;
...
/// twice the restarts a single [`crate::kinematics::NewtonRaphsonSolver`]/
/// [`crate::kinematics::LevenbergMarquardtSolver`] call would, not a
...
/// [`crate::kinematics::registry::DEFAULT_SOLVER_NAME`]'s own doc comment, which
/// points back here).
///
...
/// [`crate::kinematics::NewtonRaphsonSolver`]/[`crate::kinematics::LevenbergMarquardtSolver`]
...
impl<S: KinematicsSolver> CachedIkSolver<S> {
    ...
    /// # Errors
    ///
    /// [`crate::error::Error::Other`] if `path` cannot be read, is not a
    ...
    /// # Errors
    ///
    /// [`crate::error::Error::Other`] if `path` cannot be written, or if
