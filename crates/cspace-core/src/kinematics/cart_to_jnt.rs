...
use crate::kinematics::numeric::{cxx_max, cxx_min};
use crate::kinematics::params::SolverParams;
use crate::kinematics::registry::SolveOptions;
use crate::kinematics::velocity::solve_velocity;
...
/// [`crate::kinematics::chain::ChainInfo::full_jacobian`]'s doc comment for why this
...
/// full-space DOF's [`crate::kinematics::chain::ChainInfo::variable_index`], leaving
...
/// [`ChainInfo::full_jacobian`] call need a fresh [`crate::state::Posed`]
