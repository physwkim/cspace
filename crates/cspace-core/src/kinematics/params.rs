...
/// Search parameters for a [`crate::kinematics::KinematicsSolver`].
///
...
pub struct SolverParams {
    ...
    /// treated as zero. Used by [`crate::kinematics::NewtonRaphsonSolver`], the solver
    /// that ports `ChainIkSolverVelMimicSVD` as-is.
    pub svd_threshold: f64,
    /// Tikhonov damping constant for [`crate::kinematics::LevenbergMarquardtSolver`]'s
    ...
    /// truncated-SVD solver; see [`crate::kinematics::LevenbergMarquardtSolver`]'s doc
