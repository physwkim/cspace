...
/// [`crate::model::robot_model::RobotModel`]; there is no public constructor. Every
...
/// [`RobotModel::get_common_root`](crate::model::robot_model::RobotModel::get_common_root).)
...
/// substitution `crate::srdf::EndEffector::parent_group` already makes).
...
impl JointModelGroup {
    ...
    /// the fully-built [`crate::model::robot_model::RobotModel`] instead, since the
    ...
    /// pass over the fully-built [`crate::model::robot_model::RobotModel`] instead,
    ...
    /// [`crate::model::robot_model::RobotModel::descendant_link_indices`], in index
    ...
    /// fully-built [`crate::model::robot_model::RobotModel`], same as
