...
use crate::geometry::{Isometry3, Shape, Vector3};
...
/// [`crate::model::robot_model::RobotModel`]; there is no public constructor.
///
...
///    [`RobotModel::link_models`](crate::model::robot_model::RobotModel::link_models)
///    or
///    [`RobotModel::joint_models`](crate::model::robot_model::RobotModel::joint_models),
...
///    backend (`cspace-collision`, a later phase) rather than anything this
...
///    [`crate::geometry::stl`]'s STL loader — so
///    [`crate::model::robot_model::RobotModel::from_urdf_and_srdf`] takes an
///    explicit [`crate::model::MeshSearchPaths`] instead of an ament index, and a
///    `<mesh>` element resolving to anything other than a well-formed STL
///    file is skipped with a
///    [`crate::model::diagnostic::Diagnostic::UnsupportedLinkGeometry`] naming why
...
///    passes [`crate::model::MeshSearchPaths::none`], under which every `<mesh>`
...
///    DAE/OBJ parser (Assimp's formats, well beyond [`crate::geometry::stl`])
