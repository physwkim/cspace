...
use crate::octomap::error::DecodeError;
use crate::octomap::key::{KeyRay, KeySet, KeyType, OcTreeKey, compute_child_idx};
...
/// read from inside the `cspace` oracle container --
...
///   [`crate::octomap::iter::Leaves`] implements `Iterator` and stops on `None`
...
impl OcTree {
    ...
    /// (see `crates/cspace-core/tests/octomap_parity.rs`'s
    ...
    /// `crates/cspace-core/tests/octomap_parity.rs`'s
    ...
    /// Read-only access to the root node, for [`crate::octomap::iter`]'s stack-based
    /// traversal.
    ...
    /// See [`crate::octomap::iter::Leaves`].
    pub fn leaves(&self) -> crate::octomap::iter::Leaves<'_> {
        crate::octomap::iter::Leaves::new(self)
    }
    ...
    /// [`crate::octomap::iter::LeavesInBbx`].
    pub fn leaves_in_bbx(
        &self,
        min: Point3<f64>,
        max: Point3<f64>,
    ) -> Option<crate::octomap::iter::LeavesInBbx<'_>> {
        crate::octomap::iter::LeavesInBbx::new(self, min, max)
    }

    /// Upstream `begin_tree()`/`end_tree()`: iterate every node in the tree,
    /// inner nodes and leaves alike, in pre-order. See
    /// [`crate::octomap::iter::TreeNodes`].
    pub fn tree_nodes(&self) -> crate::octomap::iter::TreeNodes<'_> {
        crate::octomap::iter::TreeNodes::new(self)
    }
...
/// [`OcTree::set_clamping_thres_min`](crate::octomap::OcTree::set_clamping_thres_min)
/// and [`OcTree::set_clamping_thres_max`](crate::octomap::OcTree::set_clamping_thres_max)
...
/// ([`crate::octomap::error::DecodeError`]'s doc comment) this port replaces with an
