...
// into `crates/cspace-core/tests/fixtures/smoothing/smoothing/acceleration_filter_{request,response}.json`
...
//   [`crate::model::JointModelGroup::active_joint_names`] entry from that
...
//   [`crate::smoothing::EPSILON`]-scale tolerances would fail on that case forever, not
...
use crate::smoothing::numeric::cxx_clamp;
...
/// [`crate::model::joint::VariableBounds`]'s public fields with no
/// validation -- see [`crate::smoothing::numeric`].
...
mod tests {
    ...
    // `_response.json` (`crates/cspace-core/tests/fixtures/smoothing/smoothing/`), captured
