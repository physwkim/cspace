...
//! here and will not be: D1/D6 keep message conversion in `ros/cspace-ros`.
...
//! kinematics solver, and `cspace_core::state -> cspace_core::kinematics` is a cycle, so
...
pub use robot_state::{JointIndex, Posed, RobotState};
