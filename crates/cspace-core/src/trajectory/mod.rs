...
//! `cspace-ros` crate instead, not this one. `LimitType`/`LIMIT_TYPES` and
...
//!   preserve two overloads for. Calls [`crate::state::RobotState::update`]
...
pub use totg_trajectory::Trajectory;
