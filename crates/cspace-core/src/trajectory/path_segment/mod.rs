...
/// One piece of a [`crate::trajectory::Path`]: either a [`Linear`] segment between two
...
impl PathSegment {
    ...
    /// the parent [`crate::trajectory::Path`].
    pub(crate) fn position(&self) -> f64 {
        self.position
    }

    /// Set `position_`. Only [`crate::trajectory::Path::create`] calls this, once every
