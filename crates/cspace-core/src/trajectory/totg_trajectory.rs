...
//! [`Trajectory`]'s own doc comment are reachable from `crate::trajectory::totg_trajectory`
...
mod tests {
    ...
    use super::*;
    use crate::trajectory::path::DEFAULT_PATH_TOLERANCE;
    ...
    /// single [`crate::trajectory::path_segment::PathSegment`] has a NaN tangent —
