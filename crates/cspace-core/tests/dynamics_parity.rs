...
//! own indexing bug — see `crates/cspace-core/src/state/dynamics.rs`'s module doc
...
use cspace_core::state::DynamicsSolver;
...
/// (`crates/cspace-core/src/test_support/lib.rs`) for why a skip alone cannot be
