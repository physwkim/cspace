...
//! Parity test for [`cspace_core::geometry::bodies`] against the real
...
use cspace_core::geometry::bodies::{ConvexMesh, Cuboid, Cylinder, OBB, Sphere};
use cspace_core::geometry::{Isometry3, Mesh as ShapeMesh, Vector3};
...
fn fixture() -> BTreeMap<String, Value> {
    let path = concat!(
        ...
        "/tests/fixtures/geometry/bodies_probe.json"
    );
