...
//! Invariant-boundary tests for [`cspace_core::kinematics::set_from_ik`],
//! [`cspace_core::kinematics::resolve_ik_queries`] and
//! [`cspace_core::kinematics::set_from_ik_subgroups`].
//!
...
//!   [`cspace_core::kinematics::AttachedFrames`] can;
