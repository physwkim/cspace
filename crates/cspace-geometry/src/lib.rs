...
//!
//! ```text
//! rg -c '^//! - `' crates/cspace-geometry/src/shapes.rs                      # whole-file bullet count
//! awk 'NR==247,NR==371' crates/cspace-geometry/src/bodies.rs | grep -c '^//! - `'  # the round-8 audit block only
//! ```
//!
...
//! rg -c '#\[test\]' crates/cspace-geometry/tests/*.rs
//! ```
//!
...
//! assert_relative_eq! crates/cspace-geometry/src/*.rs` (13, the exact
...
//! now 0: `grep -n assert_relative_eq crates/cspace-geometry/src/stl.rs`
...
//!   (`rg -n serde_json crates/cspace-geometry/src/bodies.rs
//!   crates/cspace-geometry/src/transforms.rs` -- no match, neither file
