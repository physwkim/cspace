...
//! Invariant-boundary tests for [`cspace_kinematics::set_from_ik`],
//! [`cspace_kinematics::resolve_ik_queries`] and
//! [`cspace_kinematics::set_from_ik_subgroups`].
//!
...
//!   [`cspace_kinematics::AttachedFrames`] can;
