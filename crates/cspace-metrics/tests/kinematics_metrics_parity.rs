...
//! joint values through this port's [`cspace_state::RobotState`].
//!
//! Regenerate the response fixture with:
//! ```text
//! R=/home/stevek/work/moveit-rs/.caucus/worktrees/5REEQZSC40-p1-fixtures-920dace3-1
//! python3 -c "import json; print(json.dumps(json.load(open('$R/crates/cspace-metrics/tests/fixtures/panda_kinematics_metrics_request.json'))))" \
...
//! `crates/cspace-metrics/tests/fixtures/oracle-models.json`'s
...
//! `crates/cspace-metrics/tests/fixtures/panda.srdf` (see that file's
...
//! ```text
//! R=/home/stevek/work/moveit-rs/.caucus/worktrees/5REEQZSC40-p1-fixtures-920dace3-1
//! python3 -c "import json; print(json.dumps(json.load(open('$R/crates/cspace-metrics/tests/fixtures/panda_arm_5dof_kinematics_metrics_request.json'))))" \
//!   | sg docker -c "$R/tools/moveit-oracle/run-oracle.sh --urdf $R/fixtures/panda.urdf --srdf $R/crates/cspace-metrics/tests/fixtures/panda.srdf" \
//!   | python3 -c "import json,sys; print(json.dumps(json.load(sys.stdin), indent=2, sort_keys=True))"
//! ```
...
use cspace_metrics::KinematicsMetrics;
