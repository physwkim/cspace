...
/// translation does exactly this — see [`crate::joint::FloatingJoint`]).
...
/// [`crate::joint::JointModel::set_variable_bounds_from_limits`] and
/// [`crate::joint::JointModel::variable_bounds_msg`] round-trip.
///
...
pub struct JointLimits {
    /// `joint_name`. Matched against a [`crate::joint::JointModel`]'s full
