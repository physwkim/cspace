...
use cspace_geometry::quaternion::slerp_coefficients;
use cspace_geometry::{Isometry3, UnitQuaternion};
...
impl FloatingJoint {
    ...
    ///
    /// The slerp itself is [`cspace_geometry::quaternion::slerp_coefficients`],
