...
//! `rg -c '^/// - \`' crates/cspace-octomap/src/tree.rs` over that walk's
...
//! rg -c '#\[test\]' crates/cspace-octomap/src/*.rs      # sums to 44
//! ```
//!
...
//! `crates/cspace-octomap/tests/fixtures/`) against this crate's own
...
//!
//! ```text
//! rg -c '^/// - `' crates/cspace-octomap/src/tree.rs   # 159, matches §111.2's corrected total
//! rg -n '^/// - `getTreeType' crates/cspace-octomap/src/tree.rs
...
//! crates/cspace-octomap/Cargo.toml` has no match -- this crate never took
...
//!
//! ```text
//! perl tools/ci/count-relative-eq.pl crates/cspace-octomap/src/*.rs
