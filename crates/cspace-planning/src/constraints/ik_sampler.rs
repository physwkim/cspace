...
use crate::constraints::{
    ConstraintSampler, OrientationConstraint, OrientationTolerance, PositionConstraint,
};
...
/// equivalent — matching this crate's own [`crate::constraints::ConstraintRegion`], which
...
///
/// # Deviation from upstream: does not implement [`crate::constraints::ConstraintSampler`]
///
...
/// solver argument does not fit [`crate::constraints::ConstraintSampler::sample`]'s
...
/// implementer, including [`crate::constraints::JointConstraintSampler`] and
/// [`crate::constraints::UnionConstraintSampler`], which need no such thing) reopens the
...
/// [`crate::constraints::UnionConstraintSampler`] (whose element type is `Box<dyn
...
impl IkConstraintSampler {
    ...
    /// parameter (matching the same collapse [`crate::constraints::ConstraintSampler::sample`]
...
/// [`ConstraintSampler`] and can sit inside a [`crate::constraints::UnionConstraintSampler`].
///
...
pub struct IkConstraintSamplerAdapter {
    ...
    /// [`crate::constraints::UnionConstraintSampler`]'s own precomputed `frame_depends`.
...
impl IkConstraintSamplerAdapter {
    ...
    /// — the sampling-volume tie-break `crate::constraints::constraint_sampler_manager`
