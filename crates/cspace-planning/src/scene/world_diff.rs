...
//! [`cspace_collision::World`] ([`Action`] bits per object id).
//!
...
//! `cspace_collision::World` deliberately has no observer mechanism at all —
...
use cspace_collision::{Action, Notification, World};
