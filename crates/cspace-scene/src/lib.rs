...
//! state/path validity built on `cspace_constraints`'s
//! [`cspace_constraints::KinematicConstraintSet`] — see
...
//!
//! ```text
//! rg -c '^/// - `' crates/cspace-scene/src/scene.rs
//! ```
//!
...
//!
//! ```text
//! rg -n '^fn .*matches_the_oracle' crates/cspace-scene/tests/*.rs
//! ```
//!
//! finds exactly **3**:
