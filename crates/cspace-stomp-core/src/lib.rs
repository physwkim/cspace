...
//!
//! ```text
//! perl tools/ci/count-relative-eq.pl crates/cspace-stomp-core/src/*.rs
...
//!
//! ```text
//! rg -c '^\s*//! - ' crates/cspace-stomp-core/src/stomp.rs
//! 47
//! rg -c '^\s*//! - ' crates/cspace-stomp-core/src/task.rs
//! 10
//! rg -c '^\s*//! - ' crates/cspace-stomp-core/src/utils.rs
//! 14
//! ```
//!
