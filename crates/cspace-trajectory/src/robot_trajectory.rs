...
//!   workspace already behaves (`cspace_error::Error::UnknownName`).
...
//!   [`cspace_error::Error`] when the caller supplies a nonzero one
...
//!   `Result<_, cspace_error::Error>` from all of these instead.
