...
//! Parity test for the *wired* [`moveit_geometry::Shape::OcTree`] path --
//! `moveit_collision::ParryCollisionEnv::check_robot_collision`/
...
//! verifies [`moveit_geometry::compound_from_octree`] in isolation, bypassing
...
use moveit_collision::{CollisionEnv, World};
use moveit_collision::{CollisionRequest, DistanceRequest, LinkPaddingScale, ParryCollisionEnv};
use moveit_geometry::{OcTree as ShapeOcTree, Shape};
