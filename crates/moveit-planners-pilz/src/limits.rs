...
//!   [`moveit_error::Error::UnknownName`].** Matches this crate's house error
//!   convention; see `moveit-error`.
...
/// `std::map` for the same reason as `moveit_geometry::Transforms`: matching
/// ordering.
