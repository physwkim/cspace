...
// §5's "CHOMP/STOMP는 Phase 7과 같은 속성 기반 검증", §222), not a port.
...
//! compare against. See PORTING-PLAN.md §222.
//!
//! # Usage
//!
//! `cargo run --release --example stomp_benchmark_port -p
//! moveit-planners-stomp -- <seed_base> [allowed_planning_time_secs]`, with a
...
//! [`CancelHandle::cancel`](moveit_stomp_core::CancelHandle::cancel) if the
...
//! [`COL_CHECK_DISTANCE`](moveit_planners_stomp::cost_functions::COL_CHECK_DISTANCE)
