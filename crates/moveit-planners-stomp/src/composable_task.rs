...
//! `stomp_moveit::ComposableTask`: a [`moveit_stomp_core::Task`] built from
...
/// `moveit_stomp_core::task`'s module doc, the same convention this port
