...
//! becomes [`moveit_scene::PlanningScene::check_collision`] against the
...
//! [`moveit_collision::CollisionRequest::group_name`]. The contact-pair
//! message-building loop (cpp:90-98) is ported as
//! [`moveit_scene::PlanningScene::colliding_pairs`], joined into the same
