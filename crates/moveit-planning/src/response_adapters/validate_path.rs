...
//! [`moveit_scene::PlanningScene::is_path_valid`]'s own `invalid_waypoints`
...
//! [`moveit_scene::PlanningScene::is_path_valid`], fed the response
//! trajectory's waypoints (cloned out of
//! [`moveit_trajectory::RobotTrajectory`] — `is_path_valid` takes
