...
//! [`f64::clamp`]-vs-`cxx_max`/`cxx_min` fix in `moveit-constraints`, but
...
//! since [`crate::acceleration_filter::joint_acceleration_bounds`] reads
//! it straight from [`moveit_model::joint::VariableBounds`]'s public
