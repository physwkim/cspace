...
//! conversion in `ros/moveit-ros` as a `TryFrom`, never on a core type.
...
//! [`RobotModel::joint_model_group`](moveit_model::RobotModel::joint_model_group),
...
/// [`JointModelGroup::variable_names`](moveit_model::JointModelGroup::variable_names),
