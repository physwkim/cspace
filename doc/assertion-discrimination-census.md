...
— `PORTING-PLAN.md:11156` §129.3, "호환은 `TryFrom` 양방향 변환으로만" —
...
`PORTING-PLAN.md:15651` §199.2 draws its operative boundary — an
