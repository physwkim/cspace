...
* **B6** `joint_model_group_space.rs:132`: `SbpError::UnknownGroup { .. }` →
  ...
  `crates/moveit-planners-sbp/src/registry.rs:1247` row cites, because D8
