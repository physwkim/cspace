...
**Totals: 73 sites examined (67 pre-existing + `planning.rs:600,720,721,722,723,807`, new code this ledger had never censused, surfaced as orphans and closed this round — `:600,720,721,722` in-family, `:723,807` not-this-family), 69 in-family, 4 not-this-family (`constraints/set.rs:148` (`empty_constraints_is_empty_set`),
