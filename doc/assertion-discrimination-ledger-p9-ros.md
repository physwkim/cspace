...
**Totals: 66 sites examined (64 pre-existing + `planning.rs:745,762` (`a_start_state_naming_more_joints_than_it_gives_positions_is_rejected`/
`a_start_state_giving_positions_it_does_not_name_is_rejected`), new code this ledger had never censused, surfaced as orphans and closed this round), 64 in-family, 2 not-this-family (`constraints/set.rs:148` (`empty_constraints_is_empty_set`),
