...
- 16 citation sites total (3 category-a, 6 category-b, 7 confirmed-fine
  ...
  the whole audit
- All 17 EXPIRED/behavioral findings fixed this round (Round 11), one
  commit each: `5347903` (velocity-bounds behavioral fix), `0d03824`,
  `2e17cc5`, `07da239` (category-a), `770deaa`, `8acd953`, `a7542f2`,
  `6f8d0b6`, `8195829` (category-b)
