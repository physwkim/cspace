...
| `crates/moveit-scene/src/scene.rs:468-471` (`setCollisionObjectUpdateCallback`) | cited `world.hpp:304` + `planning_scene.cpp:220,326,650,655` | CONFIRMED | opened all four — exact. | |
