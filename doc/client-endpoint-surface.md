...
|---|---|---|---|---|
| `attached_collision_object` | publishes | subscriber | `ros/moveit-ros/src/bin/move_group.rs:603` | bound |
| `check_state_validity` | -- | -- | `ros/moveit-ros/src/bin/move_group.rs:633` | surplus |
...
| `move_action` | calls | action server | `ros/moveit-ros/src/bin/move_group.rs:563` | bound |
| `plan_kinematic_path` | -- | -- | `ros/moveit-ros/src/bin/move_group.rs:547` | surplus |
| `planning_scene` | -- | -- | `ros/moveit-ros/src/bin/move_group.rs:586` | surplus |
...
| `trajectory_execution_event` | publishes | subscriber | `ros/moveit-ros/src/bin/move_group.rs:621` | bound |
