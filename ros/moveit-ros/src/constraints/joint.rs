...
//! `moveit_msgs/JointConstraint` <-> [`moveit_constraints::JointConstraint`].
//! See `doc/message-mapping.md` §4.

use moveit_constraints::JointConstraint as CoreJointConstraint;
...
impl TryFrom<CoreJointConstraint> for JointConstraintMsgOut {
    ...
    /// convention expects -- confirmed in `moveit_constraints::joint`'s own
