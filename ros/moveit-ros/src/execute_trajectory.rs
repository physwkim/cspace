...
pub const SOURCE: &str = "moveit-ros/execute_trajectory";
...
/// it.
pub const NO_EXECUTION_BACKEND: &str = "moveit-ros has no trajectory execution backend, so this is upstream's own \
...
mod tests {
    ...
    fn the_result_names_this_endpoint_as_its_source() {
        ...
        assert_eq!(result.error_code.source, "moveit-ros/execute_trajectory");
        assert_ne!(result.error_code.source, "moveit-ros/move_action");
    }
