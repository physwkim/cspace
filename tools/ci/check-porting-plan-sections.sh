...
#       numbers listed. 222 and 223 are unassigned today (written without the
#       section sigil here, because `check-section-references.sh` reads a `§N`
#       as a citation and these two resolve to nothing by definition), and
#       against a declaration of exactly those two, 99 of 2391 commits fail -- 14
