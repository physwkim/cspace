...
declare -A THIRD_PARTY_PINS=(
  ...
  #
  # geometric_shapes 2.3.3 -- the pin row in §160.3, PORTING-PLAN.md:13080;
  ...
  # srdfdom 2.0.8 -- the pin row in §160.3, PORTING-PLAN.md:13081.
  [srdfdom]=58ee1eccd1c34498f67022eb2080daec5e8bc162
  # octomap v1.9.7 -- the pin row in §160.3, PORTING-PLAN.md:13082; the
