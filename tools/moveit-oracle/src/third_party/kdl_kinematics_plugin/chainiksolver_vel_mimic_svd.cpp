...
// The ONLY textual change from upstream is the #include path below, updated
// to this vendored header's own location; every other line is untouched. See
// chainiksolver_vel_mimic_svd.hpp's own vendoring note for why this file
// lives here instead of being pulled in through the full moveit_kinematics
// package.
